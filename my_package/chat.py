...
def chat(ser):
    ...
    def about_program():
        ...
        if counter_info_window == 0:
            ...
            temp_window.title('Исполнители')
            temp_window.geometry('160x70')
            temp_window['bg'] = 'lightblue'
            student_1 = tk.Label(temp_window, text="Гапчук Людмила", font=('Arial', 15), bg='lightblue')
            student_1.grid(row=0, column=0)
            student_2 = tk.Label(temp_window, text="Толпаров Натан", font=('Arial', 15), bg='lightblue')
    ...
    def source_message():
        ...
        if counter_source_window == 0:
            ...
            window_source_message.configure(bg='lightblue')
            listbox_source = tk.Listbox(window_source_message, font=('Arial', 12), bg='lightblue')
    ...
    def dest_message():
        ...
        if count_dest_window == 0:
            ...
            window_dest_message.configure(bg='lightblue')
            listbox_dest = tk.Listbox(window_dest_message, font=('Arial', 12), bg='lightblue')
